...
/*=================== Edit data for crop, notice options to call =================== */
...
if ($_POST['Edit']){
    switch ($data) {
        case 'cropName':
            $sql = "UPDATE bath_info SET bathID = (SELECT bath.bathID FROM bath 
                WHERE bath.cropName = '$value') WHERE dataID = '$id'";
            break;
        case 'dateCheck':
...
// Clicking the delete button with values
